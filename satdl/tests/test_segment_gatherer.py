...
from satdl.datasets._segment_gatherer import SlotDefinition, SegmentGatherer
...
def test_slot_definition_from_yaml(slot_definition: SlotDefinition) -> None:
    ...
    assert all(isinstance(mask.fmt, str) for mask in slot_definition.optional_file_masks + slot_definition.required_file_masks)
