...
from satdl.datasets._segment_gatherer import SlotInputFiles, SegmentGatherer


_logger = logging.getLogger(__name__)


class SatpyFolderDataset(AttributeDatasetBase[SlotInputFiles, str, xr.DataArray]):
    def __init__(
        self,
        base_folder: Union[str, Path],
        segment_gatherer: SegmentGatherer
    ) -> None:
